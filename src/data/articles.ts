...
export const articles: IArticle[] = [
  {
    ...
    createdAt: parse('2021-08-28', dateFormat, new Date()).valueOf(),
    type: 'pdf',
  ...
  },
  {
    ...
    createdAt: parse('2021-07-03', dateFormat, new Date()).valueOf(),
    type: 'pdf',
    description: '用好依赖注入',
  },
  {
    title: '求两个偏序集的最大交集',
    file: 'posets-1.pdf',
    createdAt: parse('2021-05-22', dateFormat, new Date()).valueOf(),
    type: 'pdf',
  ...
  },
  {
    ...
    createdAt: parse('2021-05-18', dateFormat, new Date()).valueOf(),
    type: 'markdown',
  ...
  },
  {
    ...
    createdAt: parse('2021-04-10', dateFormat, new Date()).valueOf(),
    type: 'pdf',
  ...
  },
  {
    ...
    createdAt: parse('2021-03-29', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    createdAt: parse('2021-03-28', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    type: 'markdown',
    createdAt: parse('2021-03-22', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    createdAt: parse('2021-03-17', dateFormat, new Date()).valueOf(),
  },
  {
    title: '服务器被入侵',
    ...
    createdAt: parse('2021-03-15', dateFormat, new Date()).valueOf(),
  },
  {
    title: '用 Markdown 写作',
    description: '重拾 Markdown.',
    createdAt: parse('2021-03-13', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    title: 'nginx -s stop',
    file: 'nginx-stop.pdf',
    createdAt: parse('2021-03-10', dateFormat, new Date()).valueOf(),
    type: 'pdf',
  ...
  },
  {
    ...
    createdAt: parse('2021-03-07', dateFormat, new Date()).valueOf(),
    type: 'pdf',
    description: '解决 R 在 macOS 下中文乱码问题．',
  },
  {
    title: '缓存配置案例',
    createdAt: parse('2021-03-05', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    createdAt: parse('2021-02-19', dateFormat, new Date()).valueOf(),
  ...
  {
    title: '向量函数的导数以及神经网络',
    createdAt: parse('2021-02-07', dateFormat, new Date()).valueOf(),
  ...
  {
    title: '主成分分析教程',
    createdAt: parse('2021-02-03', dateFormat, new Date()).valueOf(),
  ...
  {
    title: '统计学习方法的学习总结',
    createdAt: parse('2021-02-02', dateFormat, new Date()).valueOf(),
  ...
  {
    title: '三维物体的投影计算',
    createdAt: parse('2021-01-30', dateFormat, new Date()).valueOf(),
    file: 'cube.pdf',
    type: 'pdf',
  ...
  {
    title: '几个向量化计算的小技巧',
    createdAt: parse('2021-01-27', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    createdAt: parse('2021-01-23', dateFormat, new Date()).valueOf(),
  ...
  {
    title: '神经网络教程',
    createdAt: parse('2021-01-22', dateFormat, new Date()).valueOf(),
    file: 'neuralnet.pdf',
    type: 'pdf',
  ...
  {
    title: '支持向量机的简单实现',
    createdAt: parse('2021-01-19', dateFormat, new Date()).valueOf(),
    file: 'svm-intro.pdf',
    type: 'pdf',
  ...
  },
  {
    ...
    createdAt: parse('2021-01-17', dateFormat, new Date()).valueOf(),
  ...
  {
    title: 'SVD 方法应用于矩阵近似',
    createdAt: parse('2021-01-13', dateFormat, new Date()).valueOf(),
  ...
  {
    title: '并行化计算尝试',
    createdAt: parse('2021-01-12', dateFormat, new Date()).valueOf(),
    file: 'gpu-accel.pdf',
    type: 'pdf',
  ...
  },
  {
    ...
    createdAt: parse('2020-08-30', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    createdAt: parse('2020-08-23', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    type: 'markdown',
    title: '合并两个已排序数组',
    createdAt: parse('2020-08-22', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    type: 'markdown',
    title: 'LCP 问题与数据结构',
    createdAt: parse('2020-08-18', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    type: 'markdown',
    createdAt: parse('2020-08-17', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    type: 'markdown',
    createdAt: parse('2020-08-14', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    type: 'markdown',
    title: '4Sum 问题分支定界求解',
    createdAt: parse('2020-08-11', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    createdAt: parse('2020-05-09', dateFormat, new Date()).valueOf(),
    description: '魔方的可视化．',
  },
  {
    ...
    type: 'markdown',
    title: '8 皇后问题：启发式解法',
    createdAt: parse('2020-04-16', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    type: 'markdown',
    title: 'Linux 命令行工具推荐',
    createdAt: parse('2020-04-14', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    type: 'markdown',
    title: '解数独与解方程',
    createdAt: parse('2020-04-13', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    type: 'markdown',
    title: 'TLS 证书：签发与验证',
    createdAt: parse('2020-04-08', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    type: 'markdown',
    title: '符号链接和硬链接',
    createdAt: parse('2020-04-01', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    createdAt: parse('2020-03-30', dateFormat, new Date()).valueOf(),
    description: '打印本机到目标主机之间的节点．',
  },
  {
    file: 'cdn-deployment.md',
    type: 'markdown',
    createdAt: parse('2020-03-25', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    createdAt: parse('2020-03-18', dateFormat, new Date()).valueOf(),
  ...
  },
  {
    ...
    createdAt: parse('2020-03-16', dateFormat, new Date()).valueOf(),
    type: 'markdown',
  },
]
  .slice()
